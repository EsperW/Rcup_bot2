...
# HSV for green
hsv_min_green = np.array((35, 55, 115), np.uint8)
...
def line_show(img, threshold_image, x_1, y_1, x_2, y_2, color):
    ...
    point_2, x_cent_2, y_cent_2 = line_detect(img, threshold_image, x_1, y_1, x_cent_1, y_cent_1, color)#start to midle
    point_3, x_cent_3, y_cent_3 = line_detect(img, threshold_image, x_cent_1, y_cent_1, x_2, y_2, color)#midle to end

    point_4, x_cent_4, y_cent_4 = line_detect(img, threshold_image, x_1, y_1, x_cent_2, y_cent_2, color)#start to (start to midle)
...
while True:
    ...
    hsv = np.ma.masked_array(img, mask = mask_arr_3D)
